  ...
  if(isset($_POST['add'])){
    ...
    if(isset($_SESSION['cart'])){
      ...
      if(in_array($_POST['product_id'],$item_array_id)){
        ...
        echo "<script>window.location = 'consoles.php'</script>";
      }else{
...
<head>
  ...
  <link rel="stylesheet" href="./games_style/playing.css">
...
<body>
  ...
  <div class="banner">
    <img class="initialise" src="./Homepics/Gaming-Consoles.jpg" alt="">
  ...
  <div class="third_part">
    ...
    <div class="all-in">
      <div class="bg-down">
        <div class="bg-space">
          <button class="brand-name">Get Yours</button>
          <button class="adding"><a style="text-decoration: none; color: white;" href="">Games</a></button>
          <div class="space-container"> <span>Own Your Console At An Affordable Price</span></div>
          <p>Own Your Console At An Affordable Price</p>
  ...
  <div class="page-wrapper">
    <div class="containing-flexing">
      ...
      while($row = mysqli_fetch_assoc($result)){
        if(($row['id'] > 24 && $row['id']<=31) || ($row['id']>= 44 && $row['id'] <= 45 ) ){
          consoleDescription($row['product_name'], $row['product_price'], $row['product_image'], $row['id'], $row['product_link'],$row['product_msg']);
        }
