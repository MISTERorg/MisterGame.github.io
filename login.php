            ...
            <form action="login.php" method="POST">
              ...
              <div class="form-group">
                <div class="client-name">
                  <div class="text">Name or Email *</div>
                  <input class="form-control" value="<?php echo $username;?>" type="text" placeholder="Name or Email" name="username" >
                </div>
              </div>
              <div class="form-group">
                <div class="client-name">
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block " name="login-btn">Log In</button>
              </div>
              <p class="text-center">Not Yet a Member? <a href="registration.php">Sign Up</a></p>
              <p style="margin-top: -3px;" class="text-center"><a href="#">Forgot Password?</a></p>
            </form>
          </div>
        </div>
      </div>
