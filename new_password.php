            ...
            <form action="new_password.php" method="POST">
              ...
              <div class="form-group">
                <div class="client-name">
                  ...
                  <input class="form-control" type="password" placeholder="Create New Password" name="password" >
                </div>
              </div>
              <div class="form-group">
                <div class="client-name">
                  <div class="text">Confirm Password *</div>
                  <input class="form-control" type="password" placeholder="Comfirm New Password" name="passwordConf" >
                </div>
              </div>
              <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block " name="change-password">Change</button>
              </div>
            </form>
          </div>
        </div>
