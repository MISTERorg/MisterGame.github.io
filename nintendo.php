...
<head>
  ...
  <link rel="stylesheet" href="./games_style/ninen.css">
...
<body>
  ...
  <div class="banner">
    <img class="actualise" src="./pictures/3XJHAI.png" alt="">
  ...
  <div class="third_part">
    ...
    <div class="all-in">
      <div class="bg-down">
        <div class="bg-space">
          <button class="brand-name">Nintendo Switch</button>

          <div class="space-container"> <span>Already Avaible Get Yours Now</span></div>
          <p>Already Avaible Get Yours Now</p>

        </div>
        <button class="adding">Buy Now</button>
    ...
    <div class="containing-flexing">
      ...
      while($row = mysqli_fetch_assoc($result)){
        if($row['id']>8 && $row['id']<=16 ){
          nintendo($row['product_name'], $row['product_price'], $row['product_image'], $row['id'], $row['product_link'], $row['product_msg']);
        }
