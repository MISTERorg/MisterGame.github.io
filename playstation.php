...
<body>
  ...
  <div class="third_part">
    ...
    <div class="bg-down">
      <div class="bg-space">
        <button class="brand-name">PlayStation 5</button>

        <div class="space-container"> <span>Launches Holiday 2020</span></div>
        <p>Launches Holiday 2020</p>
    ...
    <div class="containing-flexing">
      ...
      <?php
        ...
        while($row = mysqli_fetch_assoc($result)){
          ...
          if(($row['id']>=1 && $row['id']<=8) || ($row['id']>= 32 && $row['id'] <= 35 )){
            component($row['product_name'], $row['product_price'], $row['product_image'], $row['id'], $row['product_link'], $row['product_msg'], $row['quantity']);
          }
        }
