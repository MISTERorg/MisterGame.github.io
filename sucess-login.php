      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 offset-md-4 form-div login">
            ...
            <a href="registration.php?logout=1" class="logout">Logout</a>
            ...
            <?php if($_SESSION['verified']): ?>
              <button class="btn btn-block btn-lg btn-primary"> <a style="color: white; text-decoration: none;" href=""> I am Verified!!!</a></button>
            <?php endif;?>
          </div>
