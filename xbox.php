...
<head>
  ...
  <link rel="stylesheet" href="./games_style/series.css">
...
<body>
  ...
  <div class="banner">
    <img class="actualise" src="./Homepics/xbox.jpg" alt="">
  ...
  <div class="third_part">
    ...
    <div class="all-in">
      <div class="bg-down">
        <div class="bg-space">
          <button class="brand-name">Xbox Series X</button>

          <div class="space-container"> <span>Lunch Holidays 2020</span></div>
          <p>Lunch Holidays 2020</p>

        </div>
        <button class="adding">PreOrder Now</button>
  ...
  <div class="page-wrapper">
    <div class="containing-flexing">
      ...
      while($row = mysqli_fetch_assoc($result)){
        if($row['id']>16 && $row['id']<25){
          xbox($row['product_name'], $row['product_price'], $row['product_image'], $row['id'], $row['product_link'], $row['product_msg']);
        }
      }
    ?>
